...
class Lead {
    ...
    async leadDetails(user, { leadId }) {
        ...
        let fields = ["name", "team_id", "partner_name", "mobile", "enquiry_id", "user_id", "sale_number", "stage_id", "activity_date_deadline"];
        ...
        if (leadDetails == null || leadDetails == undefined || leadDetails.records.length < 1) {
            ...
            if (leadDetails.records[0].enquiry_id != false) {
                ...
                let fields1 = ["product_id", "product_color", "product_variant", "source_id", "partner_email"];
