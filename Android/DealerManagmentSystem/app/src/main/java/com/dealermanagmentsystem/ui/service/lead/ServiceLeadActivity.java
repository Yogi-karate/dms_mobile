...
import com.dealermanagmentsystem.adapter.ServiceLeadAdapter;
...
public class ServiceLeadActivity extends BaseActivity implements IServiceLeadView {

    @BindView(R.id.recycler_View)
    RecyclerView recyclerView;
    Activity activity;
    ServiceLeadsPresenter presenter;
    String strState;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = ServiceLeadActivity.this;
    ...
    public void onSuccessServiceLeads(EnquiryResponse enquiryResponse) {
        if (enquiryResponse.getRecords() != null) {
            serviceLeadAdapter = new ServiceLeadAdapter(this, enquiryResponse.getRecords());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                serviceLeadAdapter.filter(newText);
                return true;
            }
        });
    ...
    private void getCallDetails(Activity activity) {
        ...
        if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.READ_CALL_LOG) != PackageManager.PERMISSION_GRANTED) {
            ...
            Cursor cur = activity.getContentResolver().query(CallLog.Calls.CONTENT_URI, null, null, null, android.provider.CallLog.Calls.DATE + " DESC limit 1;");
