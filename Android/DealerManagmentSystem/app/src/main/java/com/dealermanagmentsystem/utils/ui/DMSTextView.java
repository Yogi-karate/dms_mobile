...
public class DMSTextView extends AppCompatTextView {

    public DMSTextView(Context context) {
        super(context);
        if (!isInEditMode())
            init();
    }

    public DMSTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (!isInEditMode())
            init();
    }

    public DMSTextView(Context context, AttributeSet attrs, int defStyle) {
